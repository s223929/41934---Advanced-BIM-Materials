...
The construction industry is gradually integrating OpenBIM, and it is becoming more widely adopted. Because of this development, it is quite likely that I will end up using OpenBIM in my professional life. I also found the presentations from SWECO and NEE very interesting, and I can easily see myself working in a company like that. I am excited to see where OpenBIM will be in 10 years.
...
In A1, I realized how much more complex BIM becomes when you don’t just model, but start extracting data and working with it. I went from being able to “work in models” to actually understanding IFC as a data structure. This was also where we decided to work with LCA and where we developed a simple piece of code that became the foundation for the entire A3 assignment.

A2 gave me a better understanding of how data, materials, and processes connect on a more technical level, and it really helped me how to structure the workflow around our use case. It was diffecult to develop a tool that would actually be useful for others, as it required balancing technical complexity with usability. Overall, A2 made the following assignments easier to approach.
